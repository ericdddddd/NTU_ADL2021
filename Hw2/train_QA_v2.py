...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default= './result/', help="Where to store the final model.")
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        train_file_path = ['./dataset/train.json' , './dataset/context.json']
        validation_file_path = ['./dataset/public.json' , './dataset/context.json']
        raw_datasets = load_dataset(args.dataset_name , data_files = {'train':train_file_path , 'validation':validation_file_path})
    else:
        data_files = {}
        if args.train_file is not None:
